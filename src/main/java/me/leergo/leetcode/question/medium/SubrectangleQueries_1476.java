...
public class SubrectangleQueries_1476 {
    public static void main(String[] args) {
        ...
        SubrectangleQueries solution = new SubrectangleQueries_1476().new SubrectangleQueries(data);
        System.out.println("---------------------1");
        System.out.println(solution.getValue(0, 2));
        System.out.println("---------------------2");
        printMatrix(solution.rectangle);
